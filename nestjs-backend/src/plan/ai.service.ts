...
export class AiService {
  ...
  private buildTravelRequestMarkdown(request: TravelPlanAgentRequestDto): string {
  ...
  private getFlightFallback(destination: string, travelRequest: any): string {
  ...
  private getHotelFallback(destination: string, travelRequest: any): string {
  ...
  private getRestaurantFallback(destination: string, travelRequest: any): string {
  ...
  private getItineraryFallback(destination: string, startDate: string, endDate: string, duration: number, travelRequest: any): string {
  ...
  private getBudgetFallback(destination: string, budget: number, currency: string, travelRequest: any): string {
